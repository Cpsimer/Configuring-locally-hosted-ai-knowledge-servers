...
| :-------------: | :-------------------------------: | :----------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------: |
|  **Must-have**  |           Dynamic Bases           | Now with T-Rex view: Filter by recommended taxonomy (e.g., taxonomy: Propulsion for tech notes). |  Enables NASA program types + PARA routing; CODE Organize via auto-suggestions.  |
|  **Must-have**  | Actionable Templates & Properties |           YAML with taxonomy_recommendation field (e.g., ensemble probs from models).            |  Consistency per Obsidian/MBE; prevents silos by recommending multi-PARA fits.   |
...
| **Could-have**  |     Network-Integrated Access     |                   NAS as "taxonomy database" for training simple models offline.                 |                       Ties to hardware; secure KM sharing.                       |
